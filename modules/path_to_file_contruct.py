'''This module is used to build the path to key directory and path to the public key to be readed'''
...
class Constructor:
    ...
    def create_key_dir(self):
        '''
            create_key_dir - Create Key directory, is a method use to create the directories 
        ...
        '''
        working_cipher_file = self.file_path()
