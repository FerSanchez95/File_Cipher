...
from modules.time_stamp import timeStamp
from modules.path_to_file_contruct import Constructor
...
class AesEncryptor:
    ...
    def __init__(self, file_name: str, byte_lenght: int) -> None:
        ...
        self.file, self.key_dir, self.public_key_name, self.private_key_name = \
            path_creation_instance.create_key_dir()
